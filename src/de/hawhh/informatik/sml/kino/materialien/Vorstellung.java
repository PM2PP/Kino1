...
public class Vorstellung
{
	...
	private int _anzahlAusgewaehlterPlaetze;
	...
	/**
	 * Gibt an, ob ein bestimmter Platz bereits ausgewählt ist.
	 * 
	 * @param platz
	 *            der Sitzplatz.
	 * 
	 ...
	 * @require hatPlatz(platz)
	 */
	public boolean istPlatzAusgewaehlt(Platz platz)
	{
		assert platz != null : "Vorbedingung verletzt: platz != null";
		assert hatPlatz(platz) : "Vorbedingung verletzt: hatPlatz(platz)";
...
//	 * @require !istPlatzAusgewaehlt(reihe, sitz)
	 ...
	 */
	public void auswahlPlatz(Platz platz)
	{
		assert platz != null : "Vorbedingung verletzt: platz != null";
		assert hatPlatz(platz) : "Vorbedingung verletzt: hatPlatz(platz)";
...
//		PlatzVerkaufsWerkzeug.ausgewaehltePlaetze();
	...
	/**
	 * Auswalt eines Platzes zurückrufen.(deselktion)
	 * 
	 * @param platz
	 *            der Sitzplatz.
	 * 
	 ...
	 * @require istPlatzAusgewaelt(reihe, sitz)
	 * 
	 * @ensure !istPlatzAusgewaelt(reihe, sitz)
	 */
	public void deselektionPlatz(Platz platz)
	{
		assert platz != null : "Vorbedingung verletzt: platz != null";
		assert hatPlatz(platz) : "Vorbedingung verletzt: hatPlatz(platz)";
		assert istPlatzAusgewaehlt(platz) : "Vorbedingung verletzt: istPlatzAusgewaehlt(platz)";
	 ...
	 * Gibt die Anzahl verkaufter Plätze zurück.
	 */
	public int getAnzahlAusgewaehlterPlaetze()
	{
		return _anzahlAusgewaehlterPlaetze;
	}
	

	/**
	 * Wält die gegebenen Plätze aus.
	 * 
	 * @require plaetze != null
	 * @require hatPlaetze(plaetze)
	 * @require sindAuswaehlbar (plaetze)
	 * 
	 * @ensure alle angegebenen Plätze sind ausgewaehlt
	 */
	public void auswaehlenPlaetze(Set<Platz> plaetze)
	{
		assert plaetze != null : "Vorbedingung verletzt: plaetze != null";
		assert hatPlaetze(plaetze) : "Vorbedingung verletzt: hatPlaetze(plaetze)";
		//assert sindAuswaehlbar(plaetze) : "Vorbedingung verletzt: sindAuswaehlbar(plaetze)";
	...
	/**
	 * Prüft, ob die gegebenen Plätze alle ausgewählt werden können. Dafür wird
	 * geschaut, ob keiner der gegebenen Plätze bisher ausgewählt ist.
	 * 
	 * Liefert true, wenn alle Plätze auswählbar sind, sonst false.
	 * 
	 * @require plaetze != null
	 * @require hatPlaetze(plaetze)
	 */
	public boolean sindAuswaehlbar(Set<Platz> plaetze)
	{
		assert plaetze != null : "Vorbedingung verletzt: plaetze != null";
		assert hatPlaetze(plaetze) : "Vorbedingung verletzt: hatPlaetze(plaetze)";
		...
		for (Platz platz : plaetze)
		{
			result &= !istPlatzAusgewaehlt(platz);
		}
		return result;
	}
	...
	/**
	 * Deselektiere die gegebenen Plätze.
	 * 
	 * @require plaetze != null
	 * @require hatPlaetze(plaetze)
	 * @require sindDeselektierbar(plaetze)
	 * 
	 * @ensure alle angegebenen Plätze sind deselektiert
	 */
	public void deselektierePlaetze(Set<Platz> plaetze)
	{
		assert plaetze != null : "Vorbedingung verletzt: plaetze != null";
		assert hatPlaetze(plaetze) : "Vorbedingung verletzt: hatPlaetze(plaetze)";
		assert sindDeselektierbar(plaetze) : "Vorbedingung verletzt: sindDeselektierbar(plaetze)";

		for (Platz platz : plaetze)
		{
			deselektionPlatz(platz);
		}
	}

	/**
	 * Prüft, ob die gegebenen Plätze alle deselektierbar sind. Dafür wird geschaut, ob
	 * jeder gegebene Platz ausgewaehlt ist.
	 * 
	 * Liefert true, wenn alle Plätze ausgewahlt sind, sonst false.
	 * 
	 * @require plaetze != null
	 * @require hatPlaetze(plaetze)
	 */
	public boolean sindDeselektierbar(Set<Platz> plaetze)
	{
		assert plaetze != null : "Vorbedingung verletzt: plaetze != null";
		assert hatPlaetze(plaetze) : "Vorbedingung verletzt: hatPlaetze(plaetze)";
